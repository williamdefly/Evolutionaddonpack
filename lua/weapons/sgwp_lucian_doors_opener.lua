...
SWEP.PrintName = Lib.Language.GetMessage("weapon_misc_lucian_doors_opener");
SWEP.Instructions = Lib.Language.GetMessage("weapon_misc_lucian_doors_opener_desc");
SWEP.Category = "EAP"
end
...
function SWEP:SpawnLucian()
	...
	--		 ang.p = 0; ang.r = (ang.r+90) % 360; ang.y = (ang.y+180) % 360;
		...
		if(IsValid(tr.Entity) and not tr.Entity:GetClass() == "doors" or tr.StartPos:Distance(pos)>75 or not IsValid(tr.Entity))then
		...
		if tr.Entity:GetClass() == "doors" and tr.Entity:GetModel() == "models/madman07/doors/dest_door.mdl" then
			...
			self:Remove()
		elseif tr.Entity:GetClass() == "doors_frame" and tr.Entity:GetModel() == "models/madman07/doors/dest_frame.mdl" then
