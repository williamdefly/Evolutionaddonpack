...
TOOL.Name=Lib.Language.GetMessage("stool_staff");
...
TOOL.Entity.Class = "staffweapon_glider";
...
TOOL.Topic["name"] = Lib.Language.GetMessage("stool_staff_weapon_spawner");
TOOL.Topic["desc"] = Lib.Language.GetMessage("stool_staff_weapon_create");
TOOL.Topic[0] = Lib.Language.GetMessage("stool_staff_weapon_desc");
TOOL.Language["Undone"] = Lib.Language.GetMessage("stool_staff_weapon_undone");
TOOL.Language["Cleanup"] = Lib.Language.GetMessage("stool_staff_weapon_cleanup");
TOOL.Language["Cleaned"] = Lib.Language.GetMessage("stool_staff_weapon_cleaned");
TOOL.Language["SBoxLimit"] = Lib.Language.GetMessage("stool_staff_weapon_limit");
--################# Code
...
function TOOL:ControlsPanel(Panel)
	...
	Panel:AddControl("Numpad",{
		ButtonSize=22,
		Label=Lib.Language.GetMessage("stool_staff_weapon_shoot"),
		Command="staffweapon_shoot",
		Label2=Lib.Language.GetMessage("stool_staff_weapon_explode"),
		Command2="staffweapon_explode",
	});
	Panel:AddControl("Color",{
		Label = Lib.Language.GetMessage("stool_staff_weapon_color"),
		Red = "staffweapon_r",
		Green = "staffweapon_g",
		Blue = "staffweapon_b",
		ShowAlpha = 0,
	...
	Panel:AddControl("PropSelect",{Label=Lib.Language.GetMessage("stool_model"),ConVar="staffweapon_model",Category="",Models=self.Models});
	...
	Panel:CheckBox(Lib.Language.GetMessage("stool_staff_weapon_explosion"),"staffweapon_explosion");
	--Panel:CheckBox("Colorize Explosion","staff_weapon_explosion_colorize");
	Panel:CheckBox(Lib.Language.GetMessage("stool_autoweld"),"staffweapon_autoweld");
	if(Lib.HasResourceDistribution) then
		Panel:CheckBox(Lib.Language.GetMessage("stool_autolink"),"staffweapon_autolink"):SetToolTip(Lib.Language.GetMessage("stool_autolink_desc"));
	end
end
