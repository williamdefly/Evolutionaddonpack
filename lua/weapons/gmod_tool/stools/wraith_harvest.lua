...
-- The original Wraith Harvester spawntool code has been replaced with this version which has fully stargatepack support.
...
TOOL.Name = Lib.Language.GetMessage("stool_wraith_harvest");
...
TOOL.Entity.Class = "wraith_harvest";
...
TOOL.Topic["name"] = Lib.Language.GetMessage("stool_wraith_harvest_spawner");
TOOL.Topic["desc"] = Lib.Language.GetMessage("stool_wraith_harvest_create");
TOOL.Topic[0] = Lib.Language.GetMessage("stool_wraith_harvest_desc");
TOOL.Language["Undone"] = Lib.Language.GetMessage("stool_wraith_harvest_undone");
TOOL.Language["Cleanup"] = Lib.Language.GetMessage("stool_wraith_harvest_cleanup");
TOOL.Language["Cleaned"] = Lib.Language.GetMessage("stool_wraith_harvest_cleaned");
TOOL.Language["SBoxLimit"] = Lib.Language.GetMessage("stool_wraith_harvest_limit");
--################# Code
...
function TOOL:ControlsPanel(Panel)
	Panel:AddControl("Numpad",{
		ButtonSize=22,
		Label=Lib.Language.GetMessage("stool_wraith_harvest_suck"),
		Command="wraith_harvest_suck",
		Label2=Lib.Language.GetMessage("stool_wraith_harvest_spit"),
		Command2="wraith_harvest_spit",
	});
	Panel:AddControl("PropSelect",{Label=Lib.Language.GetMessage("stool_model"),ConVar="wraith_harvest_model",Category="",Models=self.Models});
	Panel:CheckBox(Lib.Language.GetMessage("stool_wraith_harvest_beam"),"wraith_harvest_always_down");
	Panel:CheckBox(Lib.Language.GetMessage("stool_autoweld"),"wraith_harvest_autoweld");
	if(Lib.HasResourceDistribution) then
		Panel:CheckBox(Lib.Language.GetMessage("stool_autolink"),"wraith_harvest_autolink"):SetToolTip(Lib.Language.GetMessage("stool_autolink_desc"));
	end
end
...
--################# Register hooks. Needs to be called after all functions are loaded!
TOOL:Register();