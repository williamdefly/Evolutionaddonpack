...
TOOL.Name=Lib.Language.GetMessage("stool_iris_infinity");
...
TOOL.ClientConVar["model"] = "models/cos/Stargate/iris.mdl";
...
function TOOL:ControlsPanel(Panel)
	Panel:AddControl("Numpad",{
		...
		Command="iris_infinity_toggle",
	});
	Panel:AddControl("Numpad",{
		ButtonSize=22,
		Label=Lib.Language.GetMessage("stool_activate"),
		Command="iris_infinity_activate",
		Label2=Lib.Language.GetMessage("stool_deactivate"),
		Command2="iris_infinity_deactivate",
	});
	Panel:CheckBox(Lib.Language.GetMessage("stool_autoweld"),"iris_infinity_autoweld");
end
