...
TOOL.Name=Lib.Language.GetMessage("stool_cloak");
...
TOOL.Entity.Class = "cloakinggenerator";
...
TOOL.Topic["name"] = Lib.Language.GetMessage("stool_stargate_cloaking_spawner");
TOOL.Topic["desc"] = Lib.Language.GetMessage("stool_stargate_cloaking_create");
TOOL.Topic[0] = Lib.Language.GetMessage("stool_stargate_cloaking_desc");
TOOL.Language["Undone"] = Lib.Language.GetMessage("stool_stargate_cloaking_undone");
TOOL.Language["Cleanup"] = Lib.Language.GetMessage("stool_stargate_cloaking_cleanup");
TOOL.Language["Cleaned"] = Lib.Language.GetMessage("stool_stargate_cloaking_cleaned");
TOOL.Language["SBoxLimit"] = Lib.Language.GetMessage("stool_stargate_cloaking_limit");
--################# Code
...
function TOOL:ControlsPanel(Panel)
	Panel:AddControl("Slider",{Label=Lib.Language.GetMessage("stool_size"),Type="Integer",Min=1,Max=1000,Command="cloaking_generator_size"});
	Panel:AddControl("Label",{Text=Lib.Language.GetMessage("stool_stargate_cloaking_note")});
	Panel:AddControl("Numpad",{
		ButtonSize=22,
		Label=Lib.Language.GetMessage("stool_toggle"),
		Command="cloaking_generator_toggle",
	});
	Panel:AddControl("PropSelect",{Label=Lib.Language.GetMessage("stool_model"),ConVar="cloaking_generator_model",Category="",Models=self.Models});
	Panel:CheckBox(Lib.Language.GetMessage("stool_stargate_cloaking_ow"),"cloaking_generator_immunity"):SetToolTip(Lib.Language.GetMessage("stool_stargate_cloaking_ow_desc"));
	Panel:CheckBox(Lib.Language.GetMessage("stool_stargate_cloaking_nc"),"cloaking_generator_phase_shift"):SetToolTip(Lib.Language.GetMessage("stool_stargate_cloaking_nc_desc"));
	Panel:CheckBox(Lib.Language.GetMessage("stool_stargate_cloaking_ca"),"cloaking_generator_attached"):SetToolTip(Lib.Language.GetMessage("stool_stargate_cloaking_ca_desc"))
	Panel:CheckBox(Lib.Language.GetMessage("stool_autoweld"),"cloaking_generator_autoweld");
	if(Lib.HasResourceDistribution) then
		Panel:CheckBox(Lib.Language.GetMessage("stool_autolink"),"cloaking_generator_autolink"):SetToolTip(Lib.Language.GetMessage("stool_autolink_desc"));
	end
end
