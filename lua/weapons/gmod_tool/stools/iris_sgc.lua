...
TOOL.Name=Lib.Language.GetMessage("stool_iris_sgc");
...
function TOOL:ControlsPanel(Panel)
	Panel:AddControl("Numpad",{
		...
		Command="iris_sgc_toggle",
	});
	Panel:AddControl("Numpad",{
		ButtonSize=22,
		Label=Lib.Language.GetMessage("stool_activate"),
		Command="iris_sgc_activate",
		Label2=Lib.Language.GetMessage("stool_deactivate"),
		Command2="iris_sgc_deactivate",
	});
	Panel:CheckBox(Lib.Language.GetMessage("stool_autoweld"),"iris_sgc_autoweld");
end
