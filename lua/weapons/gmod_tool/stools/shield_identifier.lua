...
TOOL.Name=Lib.Language.GetMessage("shieldid_title");
...
TOOL.Entity.Class = "shields_identifier";
...
TOOL.Topic["name"] = Lib.Language.GetMessage("stool_stargate_shield_ident_spawner");
TOOL.Topic["desc"] = Lib.Language.GetMessage("stool_stargate_shield_ident_create");
TOOL.Topic[0] = Lib.Language.GetMessage("stool_stargate_shield_ident_desc");
TOOL.Language["Undone"] = Lib.Language.GetMessage("stool_stargate_shield_ident_undone");
TOOL.Language["Cleanup"] = Lib.Language.GetMessage("stool_stargate_shield_ident_cleanup");
TOOL.Language["Cleaned"] = Lib.Language.GetMessage("stool_stargate_shield_ident_cleaned");
TOOL.Language["SBoxLimit"] = Lib.Language.GetMessage("stool_stargate_shield_ident_limit");
--################# Code
...
function TOOL:ControlsPanel(Panel)
	Panel:AddControl("Label",{Text=Lib.Language.GetMessage("stool_stargate_shield_ident_text")});
	Panel:AddControl("PropSelect",{Label=Lib.Language.GetMessage("stool_model"),ConVar="shield_identifier_model",Category="",Models=self.Models});
	Panel:CheckBox(Lib.Language.GetMessage("stool_autoweld"),"shield_identifier_autoweld");
end
