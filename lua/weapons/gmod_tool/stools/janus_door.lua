...
if (CLIENT) then
	...
	language.Add("Tool_janus_door_name", "Janus Porte");
	language.Add("Tool_janus_door_desc", "Fait quelque chose dans une porte de Janus");
	language.Add("Tool_janus_door_0", "Cliquez sur quelque chose pour en faire un porte Janus.");
