...
TOOL.Name=Lib.Language.GetMessage("stool_light");

TOOL.ClientConVar["autoweld"] = 1;
TOOL.ClientConVar["brightness"] = Lib.CFG:Get("atlantis_light","max_brightness",5);
TOOL.ClientConVar["size"] = Lib.CFG:Get("atlantis_light","max_size",400);
...
TOOL.Entity.Class = "atlantislight";
...
TOOL.Topic["name"] = Lib.Language.GetMessage("stool_atlantis_light_spawner");
TOOL.Topic["desc"] = Lib.Language.GetMessage("stool_atlantis_light_create");
TOOL.Topic[0] = Lib.Language.GetMessage("stool_atlantis_light_desc");
TOOL.Language["Undone"] = Lib.Language.GetMessage("stool_atlantis_light_undone");
TOOL.Language["Cleanup"] = Lib.Language.GetMessage("stool_atlantis_light_cleanup");
TOOL.Language["Cleaned"] = Lib.Language.GetMessage("stool_atlantis_light_cleaned");
TOOL.Language["SBoxLimit"] = Lib.Language.GetMessage("stool_atlantis_light_limit");
--################# Code
...
function TOOL:ControlsPanel(Panel)
	...
	Panel:NumSlider(Lib.Language.GetMessage("stool_brightness"),"atlantislight_brightness",1,Lib.CFG:Get("atlantis_light","max_brightness",5),0);
	Panel:NumSlider(Lib.Language.GetMessage("stool_size"),"atlantislight_size",10,Lib.CFG:Get("atlantis_light","max_size",1000),0);

	Panel:AddControl("Color",{
		Label = Lib.Language.GetMessage("stool_atlantis_light_colour"),
		Red = "atlantislight_r",
		Green = "atlantislight_g",
		Blue = "atlantislight_b",
		ShowAlpha = 0,
		ShowHSV = 1,
		ShowRGB = 1,
		Multiplier = 255,
	});
	Panel:AddControl("PropSelect",{Label=Lib.Language.GetMessage("stool_model"),ConVar="atlantislight_model",Category="",Models=self.Models});
	Panel:CheckBox(Lib.Language.GetMessage("stool_autoweld"),"atlantislight_autoweld");
