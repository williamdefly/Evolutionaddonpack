...
SWEP.PrintName = Lib.Language.GetMessage("eap_weapon_ronongun");
...
if (Lib.Language!=nil and Lib.Language.GetMessage!=nil) then
language.Add("HelicopterGun_ammo",Lib.Language.GetMessage("energy_cell"));
language.Add("eap_weapon_dexgun",Lib.Language.GetMessage("weapon_ronongun"));
end
