...
SWEP.ViewModel 				= "models/weapons/v_models/v_tac_goa.mdl"
SWEP.WorldModel 				= "models/weapons/w_models/w_tac_goa.mdl"
...
function SWEP:ThrowFar()
	...
	local ent = ents.Create ("ent_explosivegrenadegoauld")
