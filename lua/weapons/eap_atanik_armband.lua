...
SWEP.PrintName = Lib.Language.GetMessage("eap_weapon_misc_atanik");
...
function SWEP:OnDrop()
	...
	if (IsValid(self.OldOwner) and self.OldOwner.EAP_Atanik) then
		self.OldOwner:SetRunSpeed(1000)
		self.OldOwner:SetJumpPower(300)
		self.OldOwner:SetArmor(0)
		self.OldOwner.EAP_Atanik = nil
		self.OldOwner = NULL
	end
	return true;
end
