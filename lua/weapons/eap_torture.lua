...
SWEP.Purpose = "Torturer les êtres inferieur à vous !"
...
-- Inventory Icon
if(file.Exists("materials/VGUI/weapons/torture_inventory.vmt","GAME")) then
	SWEP.WepSelectIcon = surface.GetTextureID("VGUI/weapons/torture_inventory");
end
