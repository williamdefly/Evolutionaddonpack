...
EFFECT.Material1 = Lib.MaterialCopy("WraithBeam1","models/alyx/emptool_glow");
EFFECT.Material2 = Lib.MaterialCopy("WraithBeam2","models/shadertest/predator");
...
function EFFECT:Think()
	if(self.Draw and Lib.VisualsWeapons("cl_harvester_dynlights")) then
