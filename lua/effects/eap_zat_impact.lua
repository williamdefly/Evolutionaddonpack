...
EFFECT.Material1 = Lib.MaterialFromVMT(
	"ZatFineOverlay",
	[["UnLitGeneric"
	{
...
EFFECT.Material2 = Lib.MaterialCopy("ZatHit","models/alyx/emptool_glow");
...
function EFFECT:Init(data)
	...
	-- ######################## Dynamic light
	if(Lib.VisualsWeapons("cl_zat_dynlights")) then
	...
	if(not Lib.VisualsWeapons("cl_zat_hiteffect")) then return end;
