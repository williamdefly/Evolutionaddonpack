...
function EFFECT:Init(data)
	...
	local KawooshData = e.KawooshTypes[e.KawooshTypesFX[math.Round(data:GetMagnitude())]].KawooshData

	if Lib.VisualsMisc("cl_kawoosh_material",true) then
