...
EFFECT.Material = Lib.MaterialCopy("CloakingMuzzle","models/shadertest/predator");

local Friends = {};

net.Receive("Lib.Cloak.Friends",function(len)
	local tbl = {}
...
function EFFECT:Init(data)
	...
	if(self.LifeTime > 1) then
		self.UseShader = Lib.VisualsMisc("cl_cloaking_shader");
	else
		self.UseShader = Lib.VisualsMisc("cl_cloaking_hitshader");
	end
