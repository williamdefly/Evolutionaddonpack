...
function EFFECT:Init(data)
	if(not Lib.VisualsMisc("cl_shield_bubble")) then return end;
	...
	if (model == "ship_shuttle") then self.Entity:SetModel(Model("models/Madman07/shields/destiny_shield.mdl"));
