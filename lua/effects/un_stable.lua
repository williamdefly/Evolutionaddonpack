...
local matLight		= {}
	...
	matLight.two	= Lib.MaterialFromVMT(
	"UnstableGlow",
	[["UnLitGeneric"
	{
...
function EFFECT:Init(data)
	...
	self.StartPos	= Lib.GetEntityCentre(self.EntityG)
	self.EntityE	= Lib.FindEntInsideSphere(self.StartPos, 10, "event_horizon")[1]
