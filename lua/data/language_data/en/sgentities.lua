...
ent_ship_anubisms = Anubis MotherShip
ent_ship_daedalus = Daedalus
ent_ship_dart   = Dart
ent_ship_deathglider   = Death Glider
ent_ship_destiny = Destiny
ent_ship_f302    = F302
ent_ship_gateglider = Gate Glider
ent_ship_gateseeder = GateSeeder
ent_ship_hatak = Ha'tak
ent_ship_jumper = Puddle Jumper
ent_ship_oneill = O'neill
ent_ship_orims = Ori MotherShip
ent_ship_prometheus = Prometheus
ent_ship_replicator = Replicator MotherShip
...
ent_sarco_enter = try to enter in sarcophagus
ent_sarco_full = Your life is already full.
ent_sarco_god_inside = Your God is already inside
