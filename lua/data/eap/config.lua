...
# If you want to change config value, read the "How to create your own configs.txt" which is inside the same folder like this file!
...
world_blocked = false
# How many damage should be taken before do wormhole jump? (one weapon shoot is around 70-100 damage)
# set to 0 for disable this feature
wormholejump = 3000
# Do you force client to play wormhole animation ?
wormhole_animation = false
