...
MsgN("librairies/server/spawner.lua")
...
Lib.GateSpawner.GravityController = {};
...
function Lib.GateSpawner.LoadConfig()
	...
	if(ini) then
		...
		Lib.GateSpawner.MDHDs = ini.mobile_dhd or {};
		...
		Lib.GateSpawner.RingBase = ini.ring_base or {};
		Lib.GateSpawner.RingPanel = ini.ring_panel or {};
		Lib.GateSpawner.SGULightUp = ini.sgu_stuff or {};
		Lib.GateSpawner.FloorChev = ini.floorchevron or {};
		Lib.GateSpawner.Ramp = ini.ramp or {};
		Lib.GateSpawner.Brazier = ini.brazier or {};
		Lib.GateSpawner.GravityController = ini.gravitycontroller or {};
		Lib.GateSpawner.AtlantisLight = ini.atlantis_light or {};
		Lib.GateSpawner.AtlantisTransporter = ini.atlantis_transporter or {};
		Lib.GateSpawner.Doors = ini.cap_doors or {};
		Lib.GateSpawner.DoorButtons = ini.cap_doors_contr or {};
		Lib.GateSpawner.Console = ini.cap_console or {};
		return true;
	end
	return false;
end
...
function Lib.GateSpawner.Spawn(v,protect,k,k2)
	...
	if(v.position and v.classname) then
		...
		local IsGate = v.classname:find("sg_") and not v.classname:find("iris");
