...
function PANEL:Init()
	...
	self.Logo:SetSize(16,16);
 	...
 	self.TextEntry:SetText("")
  	...
  	self.ListView:AddColumn(Lib.Language.GetMessage("atl_tp_05")):SetFixedWidth(270); //380
	self.ListView:AddColumn(Lib.Language.GetMessage("atl_tp_group")):SetFixedWidth(110);
	--self.ListView:AddColumn(Lib.Language.GetMessage("atl_tp_local")):SetFixedWidth(45);
	...
	self.RefreshImageButton:SetTooltip(Lib.Language.GetMessage("stargate_vgui_refresh"));
	self.RefreshImageButton.DoClick = function(ImageButton)
 	...
 	self.L1:SetText(Lib.Language.GetMessage("atl_tp_02"))
	...
	self.Button:SetText(Lib.Language.GetMessage("atl_tp_04"))
...
function PANEL:Init()
	...
	self.Logo:SetSize(16,16);
 	...
 	self.L1 = vgui.Create( "DLabel", self )
 	self.L1:SetText(Lib.Language.GetMessage("atl_tp_01"))
 	self.L1:SetFont("OldDefaultSmall")
 	self.L1:SetPos( 30, 0 )
 	self.L1:SetSize( 400, 36 )	
	
	self.NameLabel = vgui.Create( "DLabel", self );
	self.NameLabel:SetText(Lib.Language.GetMessage("atl_tp_name"))
	...
	self.GroupLabel:SetText(Lib.Language.GetMessage("atl_tp_group"))
	...
	self.PrivateCheckbox:SetText(Lib.Language.GetMessage("atl_tp_06"));
	self.PrivateCheckbox:SetWide(110);
	local tip = Lib.Language.GetMessage("atl_tp_07");
	...
	self.LocalCheckbox:SetText(Lib.Language.GetMessage("atl_tp_local")); //MAKE Language COMPATIBLE
	self.LocalCheckbox:SetWide(110);
	local tip = Lib.Language.GetMessage("atl_tp_08");
	...
	self.Button:SetText(Lib.Language.GetMessage("atl_tp_03"))
