...
function ENT:FindDakara()
	...
	for _,v in pairs(ents.FindByClass("dakarabuilding")) do
...
if (Lib.Language!=nil and Lib.Language.GetMessage!=nil) then
	language.Add("ancient_controlpanel",Lib.Language.GetMessage("ancient_control_panel"));
end
...
function VGUI:Init()
	...
	DermaPanel:SetTitle( Lib.Language.GetMessage("dakara_panel") )
    ...
    MenuButtonCreate:SetText( Lib.Language.GetMessage("dakara_menu_12") )
