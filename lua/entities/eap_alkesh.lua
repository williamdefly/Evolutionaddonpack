...
function ENT:SpawnFunction(ply, tr) --######## Pretty useless unless we can spawn it @RononDex
	...
	local e = ents.Create("eap_alkesh")
	e:SetPos(ply:GetPos() + Vector(0,0,500))
...
if (StarGate and StarGate.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "eap_alkesh", StarGate.CAP_GmodDuplicator, "Data" )
end
...
--########## Keybinder stuff
local KBD = StarGate.KeyBoard:New("Alkesh")
--Navigation
