...
StarGate.Teleport:Add("energy_pulse_mothership",ENT.FixAngles);
...
language.Add("energy_pulse_mothership",SGLanguage.GetMessage("energy_pulse_kill"));
end
...
function ENT:Initialize()
	self.Created = CurTime();
	self.DrawShaft = true;
	self.InstantEffect = not (self.Entity:GetClass() == "energy_pulse_mothership");
