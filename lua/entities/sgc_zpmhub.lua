...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("sgc_zpmhub");
	e:SetPos(pos);
	e:SetAngles(ang);
	e:DrawShadow(true);
	e:SetVar("Owner",p);
...
language.Add("sgc_zpmhub",Lib.Language.GetMessage("stool_sgc_hub"));
end
...
function ENT:Draw()
	...
	if(not Lib.VisualsMisc("cl_draw_huds",true)) then hook.Remove("HUDPaint",tostring(self.Entity).."SGCH"); return end;
	local ang=EyeAngles()
    ang.y = ang.y;
