...
function ENT:Initialize()
	...
	self.AllowAutoTrack = Lib.CFG:Get("drone","auto_track",true);
	self.AllowEyeTrack = Lib.CFG:Get("drone","eye_track",true);
...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("drones_launcher")
...
function ENT:Use(p)
	...
	local id = "Lib.DroneLauncher"..self.Entity:EntIndex();
	local e = self.Entity;
	timer.Destroy(id);
...
language.Add("drones_launcher",Lib.Language.GetMessage("entity_drone")); -- Some idiot got smashed
end
-- Kill Icon
if(file.Exists("materials/weapons/drone_killicon.vmt","GAME")) then
	killicon.Add("drones_launcher","weapons/drone_killicon",Color(255,255,255));
