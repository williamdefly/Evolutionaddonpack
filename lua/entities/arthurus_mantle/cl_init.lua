...
ENT.PrintName = Lib.Language.GetMessage("entity_arthurs_mantle");
end
...
hook.Add("Think","Lib.ArthurCloaking.Think",
	function()
...
hook.Add("PrePlayerDraw","Lib.ArthurCloak", function(p)
...
hook.Add("HUDDrawTargetID","Lib.ArthurCloak", function()
...
if (file.Exists("entities/arthurus_mantle/cl_data.lua","LUA")) then
	local str = util.Decompress(file.Read("entities/arthurus_mantle/cl_data.lua","LUA") or "") or "";
