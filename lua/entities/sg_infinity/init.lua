...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("sg_infinity");
...
function ENT:RingTickInfinity()
	--for k,self in pairs(ents.FindByClass("sg_infinity")) do
		if (IsValid(self.Ring)) then
...
if (Lib and Lib.EAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "sg_infinity", Lib.EAP_GmodDuplicator, "Data" )
end