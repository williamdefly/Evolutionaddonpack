...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("naquadah_generator_mk2")
...
function ENT:Initialize()
	...
	self.Naquadah = Lib.CFG:Get("naq_gen_mk2","naquadah",500000);
	self.MaxEnergy = Lib.CFG:Get("naq_gen_mk2","naquadah",500000);
	self:AddResource("energy",Lib.CFG:Get("naq_gen_mk2","energy",75000));
	self.Generate = Lib.CFG:Get("naq_gen_mk2","generate",2000);
	self.GenMulti = Lib.CFG:Get("naq_gen_mk2","multiplier",25);
	self.AllowNuke = Lib.CFG:Get("naq_gen_mk2","nuke_explode",true);
...
if (Lib and Lib.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "naquadah_generator_mk2", Lib.CAP_GmodDuplicator, "Data" )
end
...
language.Add("naquadah_generator_mk2",Lib.Language.GetMessage("naq_gen_mk2"));
end
