...
function ENT:Initialize()
	...
	if(r == 255 and g == 255 and b == 255) then
		self.Entity:SetColor(Color(math.random(20,20),100,120,255));
	end
...
StarGate.Teleport:Add("energy_pulse_oneil",ENT.FixAngles);
...
function ENT:Initialize()
	self.Created = CurTime();
	self.DrawShaft = true;
	self.InstantEffect = not (self.Entity:GetClass() == "energy_pulse_oneil");
