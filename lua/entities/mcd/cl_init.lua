...
ENT.PrintName = Lib.Language.GetMessage("entity_mcd");
language.Add("mcd",Lib.Language.GetMessage("entity_mcd_full"));
end
...
function ENT:Initialize()
	...
	self.Aplha = 0;
	self.AlTr = true;
	self.ProgressMsg = Lib.Language.GetMessage("mcd_progress");
end
...
function VGUI:Init()
	...
	DermaPanel:Center()
	DermaPanel:SetTitle( Lib.Language.GetMessage("mcd_title") )
	...
	/*
 	...
 	title:SetText(Lib.Language.GetMessage("mcd_title"));
  	title:SetPos( 25, 0 );
	...
	function DermaSettings:UpdateSettings(class)
		...
		if (class=="jammingdevice" or class=="shields_generator" or class=="cloakinggenerator" or class=="tollan_weapons_disabler") then
		...
		if (class=="shields_generator") then
			...
			self.Imm:SetText(Lib.Language.GetMessage("stool_immunity"));
			self.Imm:SetToolTip(Lib.Language.GetMessage("stool_stargate_shield_imm"));
			self.Imm:SizeToContents();
		end
		
		if (class=="cloakinggenerator") then
			self.Phase:SetVisible(true)
			self.Imm:SetText(Lib.Language.GetMessage("stool_stargate_cloaking_ow"));
			self.Imm:SetToolTip(Lib.Language.GetMessage("stool_stargate_cloaking_ow_desc"));
			self.Imm:SizeToContents();
		end
		
		if (class=="jammingdevice") then
			self.Imm:SetText(Lib.Language.GetMessage("stool_immunity"));
			self.Imm:SetToolTip(Lib.Language.GetMessage("stool_jamming_imm_desc"));
			self.Imm:SizeToContents();
		end
		
		if (class=="tollan_weapons_disabler") then
			self.Imm:SetText(Lib.Language.GetMessage("stool_immunity"));
			self.Imm:SetToolTip(Lib.Language.GetMessage("stool_tollan_disabler_imm"));
			self.Imm:SizeToContents();
		end
	end
	...
	Label:SetPos(15, 0);
	Label:SetText(Lib.Language.GetMessage("mcd_settings"));
    ...
    Label:SetPos( 0, 30 )
	Label:SetText(Lib.Language.GetMessage("mcd_nosettings"));
	Label:SizeToContents()	
	Label:Center()
	...
	NumPad:SetLabel1(Lib.Language.GetMessage("mcd_toggle"))
	NumPad:SetToolTip(Lib.Language.GetMessage("mcd_toggle_desc"))
    ...
    NumSliderThingy1:SetText( Lib.Language.GetMessage("mcd_size") )
    NumSliderThingy1:SetMin( 0 )
    NumSliderThingy1:SetMax( 1024 )
	NumSliderThingy1:SetValue( 800 );
    NumSliderThingy1:SetDecimals( 2 )
	NumSliderThingy1:SetToolTip(Lib.Language.GetMessage("mcd_size_desc"))
    ...
    CheckBoxThing2:SetText( Lib.Language.GetMessage("stool_stargate_cloaking_nc") )
    CheckBoxThing2:SetValue( 0 )
    CheckBoxThing2:SizeToContents()
	CheckBoxThing2:SetToolTip(Lib.Language.GetMessage("stool_stargate_cloaking_nc_desc"))
    ...
    NumSliderThingy2:SetText( Lib.Language.GetMessage("mcd_strengh") )
    NumSliderThingy2:SetMin( -5 )
    NumSliderThingy2:SetMax( 5 )
	NumSliderThingy2:SetValue( 0 );
    NumSliderThingy2:SetDecimals( 2 )
	NumSliderThingy2:SetToolTip(Lib.Language.GetMessage("stool_stargate_shield_str_desc") )
    ...
    CheckBoxThing3:SetText( Lib.Language.GetMessage("stool_stargate_shield_db") )
    CheckBoxThing3:SetValue( 1 )
    CheckBoxThing3:SizeToContents()
	CheckBoxThing3:SetToolTip(Lib.Language.GetMessage("stool_stargate_shield_db_desc"))
    ...
    CheckBoxThing4:SetText( Lib.Language.GetMessage("stool_stargate_shield_se") )
    CheckBoxThing4:SetValue( 1 )
    CheckBoxThing4:SizeToContents()
	CheckBoxThing4:SetToolTip(Lib.Language.GetMessage("stool_stargate_shield_se_desc"))
    ...
    CheckBoxThing5:SetText( Lib.Language.GetMessage("stool_stargate_shield_co") )
    CheckBoxThing5:SetValue( 0 )
    CheckBoxThing5:SizeToContents()
	CheckBoxThing5:SetToolTip(Lib.Language.GetMessage("stool_stargate_shield_co_desc"))
    ...
    CheckBoxThing6:SetText( Lib.Language.GetMessage("stool_stargate_shield_an") )
    CheckBoxThing6:SetValue( 1 )
    CheckBoxThing6:SizeToContents()
	CheckBoxThing6:SetToolTip(Lib.Language.GetMessage("stool_stargate_shield_an_desc"))
    ...
    color:SetToolTip(Lib.Language.GetMessage("mcd_color"))
    ...
    ComboBox:AddColumn(Lib.Language.GetMessage("mcd_device"))
    ComboBox.Columns[1].DoClick = function() end
	ComboBox.Setup = function(self,classes)
		if (classes["cloakinggenerator"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("stool_cloak"), "cloakinggenerator"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","cloakinggenerator"));
		end
		if (classes["shields_generator"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("stool_shield"), "shields_generator"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","shields_generator"));
		end
		if (classes["jammingdevice"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("stool_jamming"), "jammingdevice"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","jammingdevice"));
		end
		if (classes["telchakhd"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("entity_telchak"), "telchakhd"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","telchakhd"));
		end
		if (classes["zpmmk3"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("stool_zpm_mk3"), "zpmmk3"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","zpmmk3"));
		end
		if (classes["tollan_weapons_disabler"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("stool_tolland"), "tollan_weapons_disabler"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","tollan_weapons_disabler"));
		end
		--ComboBox:AddLine("Anti Preori Device", "anti_prior")
		if (classes["naquadah_generator_mk1"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("naq_gen_mk1"), "naquadah_generator_mk1"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","naquadah_generator_mk1"));
		end
		if (classes["arthurus_mantle"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("entity_arthurs_mantle"), "arthurus_mantle"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","arthurus_mantle"));
		end

		ComboBox:AddLine(Lib.Language.GetMessage("mcd_replicator"), "replicator"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","replicator"));
		
		if (classes["eap_fnp90"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("eap_weapon_p90"), "eap_fnp90"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","eap_fnp90"));
		end
		if (classes["eap_weapon_asura"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("eap_weapon_asuran"), "eap_weapon_asura"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","eap_weapon_asura"));
		end
		if (classes["eap_weapon_zat"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("eap_weapon_zat"), "eap_weapon_zat"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","eap_weapon_zat"));
		end
		if (classes["eap_sg_medkit"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("eap_weapon_misc_atl_medkit"), "eap_sg_medkit"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","eap_sg_medkit"));
		end
		if (classes["naq_bottle"]) then
			ComboBox:AddLine(Lib.Language.GetMessage("stool_naq_bottle"), "naq_bottle"):SetToolTip(Lib.Language.GetMessage("mcd_device_desc").."\n"..Lib.Language.GetMessage("mcd_classname","naq_bottle"));
		end
		ComboBox:SortByColumn(1,false)
	end
	ComboBox:SetToolTip(Lib.Language.GetMessage("mcd_device_desc"))
	...
	Label:SetFont("OldDefaultSmall");
	Label:SetPos(0, 5);
	Label:SetText(Lib.Language.GetMessage("mcd_effcolor"));
	Label:SizeToContents();
	--Label:Center();
    ...
    ecolor:SetToolTip(Lib.Language.GetMessage("mcd_effcolor_desc"))
    ...
    MenuButtonClose:SetText(Lib.Language.GetMessage("mcd_close"))
    ...
    MenuButtonCreate:SetText(Lib.Language.GetMessage("mcd_create"))
	...
	MenuButtonCreate.DoClick = function ( btn )
	    if(ComboBox:GetSelected()[1] and ComboBox:GetSelected())then
			...
			if(class == "tollan_weapons_disabler" or class == "cloakinggenerator" or class == "shields_generator" or class == "jammingdevice")then
