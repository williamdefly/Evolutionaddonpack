...
-- for k,v in pairs({"vehicle_dart","vehicle_gate_glider","vehicle_glider","vehicle_shuttle","vehicle_f302","vehicle_teltac","eap_destiny","eap_cruiser","eap_alkesh"}) do
-- 	Lib.Teleport:Add(v,ENT.FixAngles);
-- end
