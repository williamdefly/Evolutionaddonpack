...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create("rg_panel_ori");
...
if (Lib and Lib.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "rg_panel_ori", Lib.CAP_GmodDuplicator, "Data" )
end
...
ENT.PrintName = Lib.Language.GetMessage("ring_panel_ori");
end
