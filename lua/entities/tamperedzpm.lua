...
function ENT:Initialize()
	...
	self:AddResource("energy",Lib.CFG:Get("tampered_zpm","energy_capacity",5000000));
	self:SupplyResource("energy",Lib.CFG:Get("tampered_zpm","energy_capacity",5000000))
...
function ENT:NukeInit()
	...
	util.Effect("TamperedZpm_Nuke", effect)
end
...
language.Add("tamperedzpm",Lib.Language.GetMessage("stool_tzpm"));
end
