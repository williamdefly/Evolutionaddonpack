...
ENT.SoundsBak = {
	...
	Fail=Sound("stargate/dial_fail_nc.mp3"),
...
ENT.SGCChevron = {
	Sound("AlexALX/stargate/movie/sgc_chevron.mp3"),
	Sound("AlexALX/stargate/movie/sgc_chevron2.mp3")
}
...
function ENT:RingTickMovie()
	--for _,self in pairs(ents.FindByClass("sg_movie")) do
		if (IsValid(self.Ring)) then
...
if (Lib and Lib.EAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "sg_movie", Lib.EAP_GmodDuplicator, "Data" )
end