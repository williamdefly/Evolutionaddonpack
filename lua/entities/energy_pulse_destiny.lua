...
function ENT:Initialize()
	...
	if(r == 255 and g == 255 and b == 255) then
		self.Entity:SetColor(Color(math.random(230,255),150,25,255));
	end
...
StarGate.Teleport:Add("energy_pulse_destiny",ENT.FixAngles);
...
language.Add("energy_pulse_alkesh",SGLanguage.GetMessage("energy_pulse_kill"));
end
...
function ENT:Initialize()
	self.Created = CurTime();
	self.DrawShaft = true;
	self.InstantEffect = not (self.Entity:GetClass() == "energy_pulse_destiny");
