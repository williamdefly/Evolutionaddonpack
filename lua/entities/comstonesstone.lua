...
ENT.PrintName = Lib.Language.GetMessage("entity_stone");
end
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create("comstonesstone");
	ent:SetAngles(ang);
...
if (Lib and Lib.EAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "comstonesstone", Lib.EAP_GmodDuplicator, "Data" )
end
