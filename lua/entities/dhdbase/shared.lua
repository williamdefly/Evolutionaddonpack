...
properties.Add( "Lib.DHD.SG1.On",
{
	MenuLabel	=	Lib.Language.GetMessage("stargate_c_tool_01d"),
	Order		=	-100,
...
properties.Add( "Lib.DHD.SG1.Off",
{
	MenuLabel	=	Lib.Language.GetMessage("stargate_c_tool_01"),
	Order		=	-100,
...
properties.Add( "Lib.DHD.Atl.On",
{
	MenuLabel	=	Lib.Language.GetMessage("stargate_c_tool_02"),
	Order		=	-100,
	MenuIcon	=	"icon16/plugin_add.png",
...
properties.Add( "Lib.DHD.Atl.Off",
{
	MenuLabel	=	Lib.Language.GetMessage("stargate_c_tool_02d"),
	Order		=	-100,
	MenuIcon	=	"icon16/plugin_delete.png",
...
properties.Add( "Lib.DHD.Glyphs.On",
{
	MenuLabel	=	Lib.Language.GetMessage("stargate_c_tool_18"),
	Order		=	-102,
	MenuIcon	=	"icon16/plugin_add.png",
...
properties.Add( "Lib.DHD.Glyphs.Off",
{
	MenuLabel	=	Lib.Language.GetMessage("stargate_c_tool_18d"),
	Order		=	-102,
	MenuIcon	=	"icon16/plugin_delete.png",
...
properties.Add( "Lib.DHD.On",
{
	MenuLabel	=	Lib.Language.GetMessage("stargate_c_tool_20"),
	Order		=	-98,
	MenuIcon	=	"icon16/plugin_add.png",
...
properties.Add( "Lib.DHD.Off",
{
	MenuLabel	=	Lib.Language.GetMessage("stargate_c_tool_20d"),
	Order		=	-98,
	MenuIcon	=	"icon16/plugin_delete.png",
