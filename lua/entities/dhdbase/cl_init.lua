...
function ENT:Draw()
	...
	if (Lib.VisualsMisc==nil or not Lib.VisualsMisc("cl_dhd_letters",true)) then return end
...
hook.Add( "GUIMousePressed", "Lib.DHD.GUIMousePressed", function()
...
hook.Add( "PreventScreenClicks", "Lib.DHD.PropertiesPreventClicks", function()
	local ply = LocalPlayer()
	if ( !IsValid( ply ) ) then return end
