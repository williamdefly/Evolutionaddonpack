...
ENT.PrintName = Lib.Language.GetMessage("stargate_universe");
end
...
function ENT:Initialize()
	...
	self.DestinyConsoleRange = Lib.CFG:Get("destiny_console","range",1000);
...
function ENT:Think(ply)
	...
	if(not Lib.VisualsMisc("cl_stargate_un_dynlights")) then return end;
