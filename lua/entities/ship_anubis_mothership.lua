...
ENT.PrintName = Lib.Language.GetMessage('ent_ship_anubisms');
ENT.Author = ""
ENT.Spawnable = false //Disabled since a model will be added
...
function ENT:SpawnFunction(ply, tr) --######## Pretty useless unless we can spawn it @RononDex
	...
	local e = ents.Create("ship_anubis_mothership")
...
--########## Keybinder stuff
local KBD = Lib.KeyBoard:New("AnubisMotherShip")
--Navigation
