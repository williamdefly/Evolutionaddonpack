...
if (Lib!=nil and Lib.RD!=nil) then Lib.LifeSupport(ENT); end-- When you need to add LifeSupport and Wire capabilities, you NEED TO CALL this before anything else or it wont work!
ENT.Type = "anim"
...
function ENT:Initialize()
	...
	self.ConsumeAmmount = Lib.CFG:Get("cloaking","energy",300); -- Energy needed for cloaking (per second)
	self.MaxSize = Lib.CFG:Get("cloaking","max_size",1024);
