...
-- Models
ENT.Models = {
	Base="models/coreylz/Stargate/base_alt.mdl",
	Ring="models/coreylz/Stargate/ring_alt.mdl",
	Chevron="models/coreylz/Stargate/chevron_alt.mdl",
}
-- Sounds
ENT.Sounds = {
...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("sg_alteran");
...
if (Lib and Lib.EAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "sg_alteran", Lib.EAP_GmodDuplicator, "Data" )
end