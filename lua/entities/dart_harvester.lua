...
function ENT:Initialize()
	...
	self.MaxEnts = 5 --StarGate.CFG:Get("harvester","max_ents",5);
	self.AllowConstrained = false --StarGate.CFG:Get("harvester","allow_constrained",false);
	self.AllowPlayers = true --StarGate.CFG:Get("harvester","allow_players",true);
	self.AllowFrozen = false --StarGate.CFG:Get("harvester","allow_frozen",false);
	self.ConsumeEnergy = 100 --StarGate.CFG:Get("harvester","energy",100);
	self.Disallowed = {};
